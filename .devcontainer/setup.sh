...
echo "   ./bootstrap.sh"
echo ""
echo "   # configure — pass plain system prefix dirs (no /frr suffix);"
echo "   # configure.ac appends /frr internally (see configure.ac lines 42-92)"
echo "   ./configure \\"
echo "     --prefix=/usr \\"
echo "     --sysconfdir=/etc \\"
echo "     --localstatedir=/var \\"
echo "     --sbindir=/usr/lib/frr \\"
echo "     --enable-bgpd \\"
echo "     --disable-doc --disable-grpc --disable-rpki \\"
echo "     --disable-ospfapi --disable-vrrpd --disable-bgp-vnc \\"
echo "     --disable-scripting \\"
echo "     --enable-user=root --enable-group=root"
echo ""
echo "   # generate route_types.h BEFORE compiling any single .o target;"
echo "   # lib/zebra.h line 148 includes it; top-level 'make bgpd/bgpd'"
echo "   # handles this automatically, but single-file invocations do not"
echo "   make lib/route_types.h"
echo ""
echo "   # full bgpd build (handles all generated-header deps automatically)"
